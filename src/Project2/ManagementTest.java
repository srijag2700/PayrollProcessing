...
public class ManagementTest {
    ...
    public void testCalculatePayment() {
        ...
        assertEquals(3846.15, testMgmt1.getPayment()); // test case #1, calculating payment of manager
        ...
        assertEquals(3826.92, testMgmt2.getPayment()); // test case #2, calculating payment of department head
        ...
        assertEquals(3538.46, testMgmt3.getPayment()); // test case #3, calculating payment of director
    }
}